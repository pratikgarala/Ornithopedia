...
export default class RecordSightings extends React.Component {
    ...
    componentDidMount(){
        ...
        $('#liRecordSightings')[0].classList.add("active");
    ...
    enableSaveBtn(){
        console.log($("#btnSave"), document.querySelector("#btnSave"));
                    ...
                    <form>
                        ...
                        {/*<div className="row bottom_margin_20">*/}
                            ...
                            {/*<div className="col-lg-4">*/}
                                {/*<Recaptcha sitekey="6Lf1BSIUAAAAAPi5gEbQ1Ju0gjbruObZY3xffPC5"  render="explicit" onloadCallback={this.enableSaveBtn}/>*/}
                            {/*</div>*/}
                            {/*<div className="col-lg-4">*/}
                            {/*</div>*/}
                        {/*</div>*/}
                        <div className="row bottom_margin_20">
                            ...
                            <div className="col-lg-4">
                                <input id="btnSave" type="submit" value="Save"  className="btn btn-default" onClick={()=>{this.onSubmitAction()}}/>
                            </div>
                            <div className="col-lg-4">
                            </div>
                        </div>
