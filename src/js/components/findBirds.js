...
export default class FindBirds extends React.Component {
    ...
    componentDidMount() {
        ...
        $('#liBirdFinder')[0].classList.add("active");
    ...
    renderBirdNotFound(){
        console.log($("#ipBirdName"));
        // if($("#ipBirdName")[0].val().length > 2){
        //     return(
    ...
    <section id="birdFinder">
        <div className="searchBar">
            <div className="container">
                <form >
                    <input type="text" id="ipBirdName" placeholder="Enter Bird Name..." onChange={() => {this.props.onDisplayMatches()}} />
                </form>
            </div>
        </div>
