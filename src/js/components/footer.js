            ...
            <div className="row">
                <div className="col-sm-2">
                    <p>
                        ...
                        <br />
                        <Link to="/matrix" id="matrixLink">Matrix</Link>
                        <br />
                        <Link to="/recordSightings" id="recordSightingsLink">Record Sightings</Link>
                        <br />
                        <Link to="/birdIdentifier" id="birdIdentifierLink">Bird Identifier</Link>
                    </p>
                </div>
                <div className="col-sm-2">
                    <p>
                        <Link to="/birdFinder" id="birdFinderLink">Bird Finder</Link>
                        <br />
                        <Link to="/treeFinder" id="treeFinderLink">Tree Finder</Link>
                        <br />
